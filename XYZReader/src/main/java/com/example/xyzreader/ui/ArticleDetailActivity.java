...
public class ArticleDetailActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            mArticleTitle = savedInstanceState.getString(TITLE_KEY);
            mPhotoUrl = savedInstanceState.getString(PHOTO_URL_KEY);
            updateToolbar();
        }
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(TITLE_KEY, mArticleTitle);
        outState.putString(PHOTO_URL_KEY, mPhotoUrl);
    }
    ...
    private void updateToolbar() {
        ...
        Picasso.with(ArticleDetailActivity.this).load(mPhotoUrl).into(mPhotoView);
        Log.d(TAG, "update toolbar: " + mArticleTitle);
    }
